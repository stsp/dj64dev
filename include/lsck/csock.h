...
LONG32 ___csock_bind(ULONG32 fd, ULONG32 addr, ULONG32 port);
LONG32 ___csock_sendto(ULONG32 fd, ULONG32 addr, ULONG32 port, const void _V_FW(1) *buf, ULONG32 len, __out ULONG32 *sent);
LONG32 ___csock_send(ULONG32 fd, const void _V_FW(1) *buf, ULONG32 len, __out ULONG32 *sent);
LONG32 ___csock_recvfrom(ULONG32 fd, __out void _V_FW(1) *buf, ULONG32 len, __out ULONG32 *rcvd, __out ULONG32 *addr, __out ULONG32 *port);
...
LONG32 ___csock_accept(ULONG32 fd, __out ULONG32 *afd, __out ULONG32 *addr, __out ULONG32 *port);
LONG32 ___csock_select(ULONG32 *rfds, ULONG32 *wfds, ULONG32 *efds, ULONG32 *timeout);
LONG32 ___csock_connect(ULONG32 fd, ULONG32 addr, ULONG32 port);
LONG32 ___csock_getsockname(ULONG32 fd, __out ULONG32 *addr, __out ULONG32 *port);
LONG32 ___csock_getpeername(ULONG32 fd, __out ULONG32 *addr, __out ULONG32 *port);
